...
$AVDInstall = "https://wvdportalstorageblob.blob.core.windows.net/galleryartifacts/Configuration_10-27-2022.zip"
Invoke-WebRequest -UseBasicParsing -Uri $AVDInstall -OutFile "Configuration_10-27-2022.zip"
