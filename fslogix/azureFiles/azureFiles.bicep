...
module ntfsPermissions '../customScriptExtensions.bicep' = if (contains(activeDirectorySolution, 'DomainServices')) {
...
module recoveryServices './recoverServices.bicep' = if (enableRecoveryServices && contains(hostPoolType, 'Pooled')) {
...
module autoIncreasePremiumFileShareQuota '../azureFiles/autoIncreasePremiumFileShareQuota.bicep' = if (fslogixStorageService == 'AzureFiles Premium' && storageCount > 0) {
