// https://github.com/Azure/missionlz/blob/main/src/bicep/add-ons/azureVirtualDesktop/modules/fslogix/azureNetAppFiles.bicep
...
module ntfsPermissions './customScriptExtensions.bicep' = {
