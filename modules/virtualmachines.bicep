...
var SharedImageSecType = contains(ComputeGalleryProperties, 'features') ? filter(ComputeGalleryProperties.featured, feature => feature.name == 'SecurityType').value : 'Standard'
